...
{
    public class UpdateMyStatsClient:IUpdateMyStats
    {
        private readonly IAmazonDynamoDB _dynamoDb;
        private readonly ILogger<UpdateMyStatsClient> _logger;

        public UpdateMyStatsClient(IAmazonDynamoDB dynamoDb, ILogger<UpdateMyStatsClient> logger)
        {
            _logger = logger;
            _dynamoDb = dynamoDb;
        }
        public async Task<string> PutDataInBD(long chatId)
        {
            ...
            if (response_get.Item.ContainsKey("chatId"))
            {
                var name = response_get.Item["name"].S;
                ...
                return "Your stats were updated.";
            }
            else {
                return  "Nothing to update. You can add your account.\n/mystats <name>";
            }
